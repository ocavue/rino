...
const FeatureBlock: React.FC<{ title: string; desc: string }> = ({ title, desc, children }) => (
    <li>
        <div className="flex">
    ...
    <div className="mt-10 mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10">
            <ul className="md:grid md:grid-cols-2 md:col-gap-8 md:row-gap-10">
                <FeatureBlock title="What you see is what you get" desc="">
                ...
                <FeatureBlock title="Sync across all your devices" desc="">
                    <svg className="h-6 w-6" viewBox="0 0 24 24" fill="white">
