...
export const Logo: React.FC = () => (
    <div className="flex items-center">
        ...
        <h1 className="leading-6 font-medium text-gray-500 transition ease-in-out duration-150 hover:text-gray-900 focus:outline-none focus:text-gray-900 pl-4 sm:pl-6 text-xl sm:text-2xl">
            Rino
        </h1>
    </div>
)
