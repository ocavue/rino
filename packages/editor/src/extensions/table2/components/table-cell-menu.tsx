...
const DefaultTableCellMenuPopup: React.FC<TableCellMenuComponentProps> = ({ setPopupOpen, popupOpen }) => {
    ...
    return (
        ...
        >
            ...
            <DefaultTableCellMenuItem label="Color pink" onClick={setTableCellBackground("rgba(255,100,100,0.3)")} />
            <DefaultTableCellMenuItem label="Remove color" onClick={setTableCellBackground(null)} />

            <DefaultTableCellMenuItem label="Add row above" onClick={handleClick(commands.addTableRowBefore)} />
            <DefaultTableCellMenuItem label="Add row below" onClick={handleClick(commands.addTableRowAfter)} />
            <DefaultTableCellMenuItem label="Add column before" onClick={handleClick(commands.addTableColumnBefore)} />
            <DefaultTableCellMenuItem label="Add column after" onClick={handleClick(commands.addTableColumnAfter)} />

            <DefaultTableCellMenuItem label="Remove column" onClick={handleClick(commands.deleteTableColumn)} />
...
const TableCellMenu: React.FC<TableCellMenuProps> = ({ Component = DefaultTableCellMenuComponent }) => {
