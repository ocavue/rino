    ...
    return Positioner.create<DeleteButtonPositionerData>({
        ...
        getActive(props) {
            ...
            if (isCellSelection(selection)) {
                ...
                if (cellSelectionType === CellSelectionType.col || cellSelectionType === CellSelectionType.row) {
...
export const TableDeleteRowColumnButton: React.FC<TableDeleteRowColumnButtonProps> = ({ Component }) => {
    ...
    return (
        <PositionerPortal>
            <Component position={position} onClick={handleClick} onMouseOver={handleMouseOver} onMouseOut={handleMouseOut} />
        </PositionerPortal>
    )
}
